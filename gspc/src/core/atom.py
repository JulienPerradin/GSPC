...
class Atom:
    ...
    def calculate_coordination(self):
        ...
        if self.element == 'O':
            self.coordination = len([neighbour for neighbour in self.neighbours if neighbour.element == 'Si'])
        else:
            self.coordination = len([neighbour for neighbour in self.neighbours if neighbour.element == 'O'])
